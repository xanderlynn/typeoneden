...
export const GET: APIRoute = ({ props }) => {
  ...
  const color    = CAT_COLORS[category] ?? '#9C8585';
  ...
  <text x="80" y="608" font-family="Arial, sans-serif" font-size="24" font-weight="700" fill="#9C8585">TypeOneDen</text>
